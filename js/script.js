...
//Creaimo un array di oggetti

const segnaPosto = [
    {tableName:'tavoloVip'},
    {guestName:['Jhonnu Depp','Lady Gaga','Cristiano Ronaldo','Georgina Rodriguez','Chiara Ferragni',  'George Clooney', 'Amal Clooney', 'Fedez', 'Amadeus', 'Fiorello']},
